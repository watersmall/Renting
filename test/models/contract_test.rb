  ...
  test "generate contract and invoices" do
    ...
    assert_difference(['Contract.count'], 1) do
      assert_difference(['RentingPhase.count'], 2) do
        contract = Contract.generate_contract(start_date, end_date, price, cycles, renting_phases)
        ...
        invoice_records = [
          ...
          ['2017-12-05'.to_date, '2017-12-10'.to_date, '2017-11-15'.to_date, 6*1800.00*12/365]
        ]
        assert_equal invoice_records, contract.generate_invoices.pluck(:start_date, :end_date, :due_date, :total)
      end
    end
